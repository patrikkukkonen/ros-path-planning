...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            pkg_dir, 'maps', 'smalltown_world.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(pkg_dir, 'params', 'nav2_params_initial_1.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(pkg_dir, 'worlds', 'smalltown_2.world'), # TODO: FIX THIS
        description='Full path to world model file to load')

    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name',
        default_value='turtlebot3_waffle', # Use Waffle Pi instead of waffle
        description='name of the robot')

    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(tb3_gazebo_dir, 'worlds', 'waffle.model'), # default_value=os.path.join(bringup_dir, 'worlds', 'waffle.model'),
